...
from va.attack.fgsm import FGMAttack, FGSMAttack
from va.attack.pgd import L2PGDAttack, LinfPGDAttack
...
def create_attack(
    ...
    """
     ...
     Arguments:
         ...
         rand_init_type (str): random initialization type for PGD
         (default: uniform).
